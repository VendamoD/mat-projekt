  ...
  return (
    <>
      <HStack spacing="1rem" textAlign="center" display={"flex"} margin={5} borderWidth='1px' borderRadius='lg' overflow='hidden'>
        {
          //@ts-ignore
          userData ? userData.SaberPuzzle ? <Card><Image width="20vw" src="trophy.png"></Image><Text fontSize={{ base: "1.1rem" }}>Světelné meče</Text></Card> : "" : ""
        }
        {
          //@ts-ignore
          userData ? userData.WolfAndGoatPuzzle ? <Card><Image width="20vw" src="trophy.png"></Image><Text fontSize={{ base: "1.1rem" }}>Vlk, koza a zelí</Text></Card> : "" : ""
        }
        {
          //@ts-ignore
